...
# CONFIG
# ============================================================
TELEGRAM_TOKEN = os.environ.get("TELEGRAM_TOKEN", "8811395656:AAGsWJa0MdaW7YzUm-4Yvqegob2_GVF4mW4").strip()
ANTHROPIC_API_KEY = os.environ.get("ANTHROPIC_API_KEY", "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").strip()
