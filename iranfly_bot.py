...
async def generate_pdf(passenger: dict, flight: dict, template_path: str):
    ...
    # FlyTicket: fix layout to fit A4 — inject compact CSS override
    if is_flyticket:
        compact_css = """
  <style>
    /* Compact override — fit everything in one A4 page */
